...
class Exp(YoloXBaseExp):
    def __init__(self):
        ...
        self.data_dir = '/data4022/xiehaiyang/cvpr25/SimROD/SimROD_vs_DIAP/data/LOD_BMVC2021'
        self.train_ann = 'lod_dark_train_png.json'
        self.val_ann = 'lod_dark_test_png.json'
        self.test_ann = 'lod_dark_test_png.json'
        self.train_ims  = 'RAW_dark'
        self.val_ims = 'RAW_dark'
        self.test_ims = 'RAW_dark'
        # ---------------- transform config ---------------- #
