...
class Adaptive_Module(nn.Module):
    ...
    def forward(self, img):
        ...
        out_gamma, gamma = self.apply_gamma(img, para_gamma)
    ...
    def get_gamma(self,img):
        ...
        fea_gamma = fea_gamma.view(fea_gamma.shape[0], fea_gamma.shape[1])
        para_gamma = self.image_adaptive_gamma(fea_gamma)
        IA_params = tanh_range(self.gamma_range[0], self.gamma_range[1])(para_gamma)[..., None, None]
